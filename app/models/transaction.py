...
class Transaction(Base):
    ...
    credit_card_payment_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("credit_card_payments.id", ondelete="SET NULL"), nullable=True)
    credit_card_charge_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("credit_card_charges.id", ondelete="SET NULL"), nullable=True)