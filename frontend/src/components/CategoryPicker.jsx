...
import { HOME_MUTED, TILE_COLOR } from "./categoryVisuals";

// Two rows of pills sized to label length. Shared between MobileTransactionModal
// (#27) and the quick-add Entry sheet (#30) - dark TILE_COLOR palette, no
// border (solid fill instead), matching the rest of the pinned-dark mobile UI.
