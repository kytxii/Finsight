...
// content. Previously lived inside MobileHome, mounted only on the Dashboard
// tab; moving it here makes it available on every tab (Analytics, AI, ...)
// and, since it's no longer inside the sliding page layer, it no longer needs
// the delayed pop-in animation that used to work around a transform-inherited
// position jump on tab switches (formerly #46's home-ctl-in workaround - not
// needed once the element isn't inside the thing that transforms).
