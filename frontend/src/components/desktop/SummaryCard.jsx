...
import { HOME_SURFACE, HOME_TEXT, HOME_MUTED, HOME_INCOME, HOME_EXPENSE, HOME_DIVIDER } from "../shared/categoryVisuals";

const DETAIL_HEIGHT = 240;

// Chevron size, and how far the change badge slides left to clear it.
