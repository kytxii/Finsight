...
import { IconIncomeTile } from "../shared/categoryIcons";
...
// Matches the solid button treatment every other sheet already uses.
...
// Save button label across idle -> saving -> saved.
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button type="button" disabled={balanceSave.status !== "idle"}
                        onClick={() => {
                          ...
                          setBalanceError("");
                          // Discards the draft, or an abandoned edit survives to next open.
                        ...
                        <div key={g.month + gi} style={{ marginTop: gi === 0 ? 0 : 4 }}>
                          ...
                          <div style={cardStyle}>
                            {g.items.map((p, i) => {
                              ...
                              // Always uses the schedule's own name, even with only one (#97).
