...
export default function Login() {
  ...
  const focusOff = (e) => {
    e.target.style.borderColor = HOME_DIVIDER;
  };
  const oauthBtnStyle = {
    flex: 1,
    display: "flex",
  ...
  const oauthLeave = (e) => {
    ...
    e.currentTarget.style.borderColor = HOME_DIVIDER;
  };
    ...
    <>
      ...
      >
        ...
        >
          ...
          <form
            onSubmit={rateLimited ? (e) => e.preventDefault() : handleSubmit}
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: "13px", color: HOME_MUTED }}>
            ...
            {error && (
              ...
              >
                ...
                {!rateLimited && attempts > 0 && (
                  <span style={{ opacity: 0.6 }}>{attempts}/5</span>
                )}
              </p>
            )}
            ...
            <button
              ...
              style={{
                ...
                fontSize: "15px",
                fontWeight: 700,
                cursor: rateLimited || loading ? "not-allowed" : "pointer",
                transition: "filter 0.15s, opacity 0.15s",
                opacity: rateLimited ? 0.4 : 1,
                textDecoration: rateLimited ? "line-through" : "none",
              }}
              onMouseEnter={(e) => {
                if (!rateLimited && !loading)
            ...
            {loading && (
              ...
              >
                ...
                <span style={{ fontSize: "12.5px", color: HOME_MUTED }}>
                  {PHRASES[phraseIdx]}
                </span>
              </div>
            )}
            ...
            >
              ...
              <a
                ...
                style={{
                  ...
                  textDecoration: "none",
                  fontWeight: 700,
                  pointerEvents: rateLimited ? "none" : "auto",
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="#EA4335"
                    d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.46 2.09 14.97 1 12 1a11 11 0 0 0-9.82 6.06l3.66 2.85C6.71 7.31 9.14 5.38 12 5.38z"
                  />
                </svg>
                Google
              </button>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.color = HOME_TEXT;
                e.currentTarget.style.borderColor = "rgba(255,255,255,0.18)";
                e.currentTarget.style.backgroundColor =
                  "rgba(255,255,255,0.05)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.color = HOME_MUTED;
                e.currentTarget.style.borderColor = HOME_DIVIDER;
                e.currentTarget.style.backgroundColor = "transparent";
              }}
            >
